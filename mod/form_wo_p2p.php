...
$query = "SELECT * FROM app_wo_p2p WHERE login='$login' and status='0' AND tgl_upload = '$tgl' AND type_p2p='CROSS' ORDER BY lup ASC";
							...
							<div class="row">
								<div class="col-md-12">
									<div class="card" style="margin-top: 20px;">
										<div class="header">
											<h4 class="title" style="color:#008B8B">DATA WO P2P</h4>
										</div>
										<div style="overflow-x:auto;">
											<table class="table table-hover table-striped">
												<thead>
													...
													<th align="center">
														<font color="red" face="Tahoma" size="2">Avg_Total_Revenue
													</th>
													<th align="center">
														<font color="red" face="Tahoma" size="2">Area Tsel
													</th>
													<th align="center">
