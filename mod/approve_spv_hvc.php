...
//update Okt 2018
	$query="SELECT id,tgl,login,nama_agent,area,no_telp,no_inet,jenis,kategori_hvc,upd_qco,rec_qco,tgl_qco,input FROM app_tam_hvc  $whr ";
...
//echo $query;
	...
	$query="SELECT id,tgl,login,nama_agent,area,no_telp,jenis,no_inet,kategori_hvc,upd_qco,rec_qco,tgl_qco,input FROM app_tam_hvc $whr ";
		...
		<div class="content">
			...
			<div class="col-md-12">
				<div class="card card-plain">
					...
					<form id='input' name="demoform" action='approve_spv_hvc.php' method='post' accept-charset='UTF-8'>
						
						<div align="center" class="panel-heading">
                            <b>APPROVE RETURN HVC</b>
                        </div>
						<div>
							...
							<div class="card ">
								...
								<div style="overflow-x:auto;">
									<table class="table table-hover table-striped">
										...
										else if ($jb=="Tabber" && $data['upd_qco']=="$uname"){echo "<th align=\"center\"><a href=\"form_tabber3_hvc.php?id=$data[id]\">My Approve</a></th>";}
