		...
		<div class="content">
			...
			<div class="col-md-12">
				<div class="card card-plain">
					...
					<form name="demoform" action='cek_jawaban_salah_agent.php' method='post' accept-charset='UTF-8'>
                        ...
                        <tr>
							...
							<tr>
								...
								<button name="refresh" type="submit" class="btn btn-primary" onClick="location.href='cek_jawaban_salah_agent.php';">Refresh</button>
							</tr>
                                        ...
                                        echo "</th>";
											...
											<div class="modal fade" id="editDealModal-<?=$data['id']?>" tabindex="-1" role="dialog" aria-labelledby="editDealModalLabel" aria-hidden="true" data-backdrop="false">
													...
													<div class="modal-content">
														...
														<form action="cek_jawaban_salah_agent.php" method="POST" id="FormRekom_qa">
