							...
							<div class="row">
								<div class="col-md-12">
									<div class="card" style="margin-top: 20px;">
										<div class="header">
											<h4 class="title" style="color:#008B8B">DATA PROSPEK HALO</h4>
										</div>
										<div style="overflow-x:auto;">
											<table class="table table-hover table-striped">
												<thead>
													...
													<th align="center">
														<font color="red" face="Tahoma" size="2">NO INDIHOME
													</th>
													<th align="center">
														<font color="red" face="Tahoma" size="2">NAMA PELANGGAN
													</th>
													<th align="center">
														<font color="red" face="Tahoma" size="2">STATUS WA
													</th>
													<th align="center">
												...
												<tbody>
													...
													while ($data = mysqli_fetch_array($hasil)) {
														echo "<tr>
																...
																<th align=\"center\" style=\"font-size:10px\">" . $data['wa_read'] . "</th>
																...
																<th align=\"center\" style=\"font-size:10px\">
																	<a href=\"form_wo_halo_new.php?id=".$data['id']."\" class=\"btn btn-primary\">INPUT WO</a>
																</th>
															</tr>
														";
														$Page = $Page + 1;
