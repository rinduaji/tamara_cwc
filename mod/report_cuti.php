...
if(isset($save)) {
		...
		if (!mysqli_query($con, $query)) {
			...
			echo "<script>alert('Data berhasil diubah.');window.location='report_cuti.php';</script>";
		}
}
...
if($date1 != "" && $date2 != "") {
	...
	$query="select *, b.id as id_rooster, b.pola as pola_rooster FROM cc147_main_users as a INNER JOIN app_tam_roosterfix as b ON a.username = b.login INNER JOIN app_tam_master_pola as c ON b.pola = c.pola 
			WHERE b.tgl_masuk BETWEEN '$date1' AND '$date2' AND key_tkd_cuti = 'CUTI' AND b.login='$login'";
    $no=0;
	// print_r($query);
		...
		<div class="content">
			...
			<div class="col-md-12">
				<div class="card card-plain">
					...
					<form name="demoform" action='report_cuti.php' method='post' accept-charset='UTF-8'>
                        ...
                        <tr>
								...
								<button name="refresh" type="submit" class="btn btn-primary" onClick="location.href='report_cuti.php';">Refresh</button>
							</tr>
						...
						<div class="col-md-12">
							<div class="card ">
								<div class="header">
									<h4 class="title" style="color:#008B8B">Report Cuti</h4>
								</div>
								<?php
