...
//update Okt 2018
	$query="SELECT * FROM app_tam_p2p  $whr ";
		...
		<div class="content">
			...
			<div class="col-md-12">
				<div class="card card-plain">
					...
					<form id='input' name="demoform" action='approve_spv_p2p.php' method='post' accept-charset='UTF-8'>
						
						<div align="center" class="panel-heading">
                            <b>APPROVE RETURN P2P</b>
                        </div>
						<div>
								...
								<div style="overflow-x:auto;">
									<table class="table table-hover table-striped">
										<thead>
											...
											<th align="center"><font color="red" face="Tahoma" size="2">Alamat Pelanggan</font></th>
										...
										else if ($jb=="Tabber" && $data['upd_qco']=="$uname"){echo "<th align=\"center\"><a href=\"form_tabber3_p2p.php?id=$data[id]\">My Approve</a></th>";}
