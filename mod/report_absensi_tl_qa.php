...
if($date1 != "" OR $date2 != "") {
	...
	if($jabatan1 != "") {
		$data_jabatan = " AND a.user3 = '".$jabatan1."'";
	...
	$query="SELECT b.date_absen,a.user1, a.user2, a.user3, a.user4, a.user5, b.`status`, b.keterangan, e.masuk, e.pulang, b.rule FROM cc147_main_users_extended as a INNER JOIN app_tam_absen as b ON a.user1 = b.username 
			...
			b.date_absen BETWEEN '$date1 00:00:00' AND '$date2 23:59:59' $data_login $data_jabatan $data_area ORDER BY c.tgl_masuk, a.user5, a.user2, b.keterangan ASC";
		...
		<div class="content">
			...
			<div class="col-md-12">
				<div class="card card-plain">
					...
					<form name="demoform" action='report_absensi_tl_qa.php' method='post' accept-charset='UTF-8'>
						
						<div align="center" class="panel-heading">
                            <b>REPORT ABSENSI PENGAWAKAN</b>
                        </div>
						<div>
                        ...
                        <tr>
								...
								<button name="refresh" type="submit" class="btn btn-primary" onClick="location.href='report_absensi_tl_qa.php';">Refresh</button>
							</tr>
						...
						<div class="col-md-12">
							<div class="card ">
								<div class="header">
									<h4 class="title" style="color:#008B8B">DAFTAR ABSEN PENGAWAKAN</h4>
								</div>
								<?php
										...
										while($data = mysqli_fetch_array($hasil)) {
											...
											if($data['keterangan'] == "IN") {
												echo"<tr  style=\"background-color:powderblue;\">
													...
													<th align=\"center\" style=\"font-size:12px\">".$data['rule']."</th>";
													}
