		...
		<div class="content">
			...
			<div class="col-md-12">
				<div class="card card-plain">
					...
					<form name="demoform" action='pengubahan_data_hvc1.php' method='post' accept-charset='UTF-8'>
						...
						<div align="center" class="col-md-4">
							...
							<tr>
								...
								<button name="refresh" type="submit" class="btn btn-primary" onClick="location.href='pengubahan_data_hvc1.php';">Refresh</button>
							</tr>
									...
									<table class="table table-hover table-striped">
										...
										echo"<tr>
											...
											<th align="center" style="font-size:10px">
                                                    <a href="edit_data_hvc.php?id=<?=$data['id']?>" class="btn btn-primary btn-sm" >Update</a>
                                            <?php
											...
											<div class="modal fade" id="myMODAL" tabindex="-1" role="dialog" aria-labelledby="editDealModalLabel" aria-hidden="true" data-backdrop="false">
													...
													<div class="modal-content">
														...
														<div class="modal-body">
														<form action="pengubahan_data_hvc1.php" method="POST" id="FormRekom_qa">
