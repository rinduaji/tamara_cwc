...
$query = "SELECT  a.id,a.tgl,DATE_FORMAT(SUBTIME(NOW(), DATE_FORMAT(a.tgl, '%H:%i:%S')),'%H:%i:%S') as durasi,a.fastel,a.login,c.user2,a.upd_qco,c.user5,c.user1,d.name FROM app_tam_data2 a INNER JOIN cc147_main_users_extended c ON a.login  = c.user1 INNER JOIN cc147_main_users d ON a.upd_qco=d.username WHERE a.tgl BETWEEN '$tanggaldate1' AND '$tanggaldate2' and a.status='Contacted' and a.kategori='Agree' and a.follow='2' AND 
a.upd_qco NOT IN 
(
SELECT username FROM app_tam_libur WHERE tanggal='$tanggal1'
) 
ORDER BY a.upd_qco,a.tgl ASC";
										...
										<div style="overflow-x:auto;">
											<table class="table table-hover table-striped">
												<thead>
                                                    ...
                                                    <th align="center">
														<font color="red" face="Tahoma" size="2">Durasi
													</th>
													<th align="center">
														...
														<div class="modal fade" id="sendQCO<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="Form Libur" aria-hidden="true" data-backdrop="false">
															<div class="modal-dialog" role="document">
																<div class="modal-content">
																	...
																	<form action="form_data_share.php" method="POST" id="FormRekom_qa">
