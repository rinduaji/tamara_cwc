		...
		<div class="row">
			<div class="col-md-12">
				<div class="card card-plain">
					<div class="header">
						<h4 class="title">INPUT HVC <small> >>> <?php echo $login; ?></small></h4>
					</div>
					<form id='form1' name="demoform" action='input_hvc.php' method='post' accept-charset='UTF-8'>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="no_telp" value="<?php echo $no_telp; ?>" placeholder="masukkan nomor telepon" onKeyPress="return isNumberKey(event)" required />
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="no_inet" value="<?php echo $no_inet; ?>" placeholder="masukkan nomor intrernet" onKeyPress="return isNumberKey(event)" required />
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="ncli" id="ncli" value="<?php echo $ncli; ?>" placeholder="masukkan NCLI" onKeyPress="return isNumberKey(event)" required />
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<select id="kategori_hvc" name="kategori_hvc" class="form-control" value="<? echo $kategori_hvc;?>">
											<option value="">Pilih Kategori HVC</option>
											<option value="DIAMOND" <?=($kategori_hvc == "DIAMOND") ? "selected" : "";?>>DIAMOND</option>
											<option value="PLATINUM" <?=($kategori_hvc == "PLATINUM") ? "selected" : "";?>>PLATINUM</option>
											<option value="GOLD" <?=($kategori_hvc == "GOLD") ? "selected" : "";?>>GOLD</option>
											<option value="SILVER" <?=($kategori_hvc == "SILVER") ? "selected" : "";?>>SILVER</option>
											<option value="REGULER" <?=($kategori_hvc == "REGULER") ? "selected" : "";?>>REGULER</option>
										</select>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="email" name="email" value="<?php echo $email; ?>" placeholder="Masukkan Email Utama"/>
									</div>
								</div>
							</div>
							<div class="row">
