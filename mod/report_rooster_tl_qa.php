...
if($date1 != "" OR $date2 != "") {
	...
	if($jb == "qa" || $jabatan == "Supervisor QA TAM"){
		// if($area != "") {
		// 	$data_area = " AND c.user5 = '".$area."'";
		// }
		// else {
			$data_area = "";
		// }
	...
	if($jabatan1 != "") {
		$data_jabatan = " AND c.user3 = '".$jabatan1."'";
	}
	else {
		$data_jabatan = "";
	}
		...
		$query="select * FROM app_tam_roosterfix as a INNER JOIN app_tam_master_pola as b ON a.pola = b.pola INNER JOIN cc147_main_users_extended as c ON a.login = c.user1 INNER JOIN cc147_main_users as d ON d.username=c.user1 
				WHERE 
				a.tgl_masuk BETWEEN '$date1' AND '$date2' $data_jabatan $data_area ORDER BY a.tgl_masuk, a.pola, c.user5, c.user2 ASC";
		...
		<div class="content">
			...
			<div class="col-md-12">
				<div class="card card-plain">
					...
					<form name="demoform" action='report_rooster_tl_qa.php' method='post' accept-charset='UTF-8'>
						
						<div align="center" class="panel-heading">
                            <b>ROOSTER PENGAWAKAN</b>
                        </div>
						<div>
                        ...
                        <tr>
								...
								<button name="refresh" type="submit" class="btn btn-primary" onClick="location.href='report_rooster_tl_qa.php';">Refresh</button>
							</tr>
						...
						<div class="col-md-12">
							<div class="card ">
								<div class="header">
									<h4 class="title" style="color:#008B8B">Daftar Rooster Pengawakan</h4>
								</div>
								<?php
										...
										echo"<tr>
											...
											<div class="modal fade" id="editDealModal-<?=$data['id']?>" tabindex="-1" role="dialog" aria-labelledby="editDealModalLabel" aria-hidden="true" data-backdrop="false">
													...
													<div class="modal-content">
														...
														<form action="report_rooster_tl_qa.php" method="POST" id="FormRekom_qa">
