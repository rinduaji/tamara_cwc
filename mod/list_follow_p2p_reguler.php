				...
				<div class="card card-plain">
					...
					<form id='input' name="demoform" action='list_follow_p2p.php' method='post' accept-charset='UTF-8'>
						...
						<div class="col-md-12">
							<div class="card ">
								<div class="header">
									<h4 class="title" style="color:#008B8B">LIST FOLLOW UP P2P REGULER</h4>
								</div>
								<div style="overflow-x:auto;">
									...
									<table id="data-table" width="150px" class="table table-hover table-striped">
										...
										$query="SELECT * FROM app_tam_p2p a  WHERE a.follow = '8' AND a.kategori='Follow UP' AND type_p2p='REGULER' $whr ORDER BY a.tgl DESC";
