...
if (isset($tanggal)) {
	$query = "SELECT a.id,a.tgl,a.login,c.user2,a.upd_qco,c.user5,c.user1,d.name,a.fastel FROM app_tam_halo a INNER JOIN app_tam_libur b ON a.upd_qco=b.username INNER JOIN cc147_main_users_extended c ON a.login  = c.user1 INNER JOIN cc147_main_users d ON a.upd_qco=d.username WHERE b.tanggal='$tanggal1' and a.tgl BETWEEN '$tanggaldate1' AND '$tanggaldate2' and a.status='Contacted' and a.kategori='Agree' and a.valid='Not Valid' and a.follow='2' ORDER BY a.tgl DESC";
} else {
	$query = "SELECT a.id,a.tgl,a.login,c.user2,a.upd_qco,c.user5,c.user1,d.name,a.fastel FROM app_tam_halo a INNER JOIN app_tam_libur b ON a.upd_qco=b.username INNER JOIN cc147_main_users_extended c ON a.login  = c.user1 INNER JOIN cc147_main_users d ON a.upd_qco=d.username WHERE b.tanggal='$tanggal2' and a.tgl BETWEEN '$tanggaldate3' AND '$tanggaldate4' and a.status='Contacted' and a.kategori='Agree' and a.valid='Not Valid' and a.follow='2' ORDER BY a.tgl DESC";
}

$pick_data_bebas = '';
$query_cek_kirim_qco = "SELECT * FROM app_tam_halo WHERE id='$id'";
...
if($pick_data_bebas == '1') {
	...
	if ($id != "") {
		$query_edit = "UPDATE app_tam_halo SET upd_qco='$username_login', pick_data_bebas='1' WHERE id='$id'";
				...
				<div class="card card-plain">
					...
					<div>
						<div class="row row-centered">
							...
							<div align="center" class="col-md-4">
								<form id='input' name="demoform" action='form_data_libur_halo.php' method='post' accept-charset='UTF-8'>
									<tr>
									<tr>
														...
														<div class="modal fade" id="sendQCO<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="Form Libur" aria-hidden="true" data-backdrop="false">
															<div class="modal-dialog" role="document">
																<div class="modal-content">
																	...
																	<form action="form_data_libur_halo.php" method="POST" id="FormRekom_qa">
