...
$query = "SELECT DATE_FORMAT(a.tgl, '%Y-%m-%d') as tanggal, a.login, b.user2, b.user5, a.jenis,  COUNT(a.jenis) as tot_jenis, SUM(a.add_on_tsel) as revenue FROM app_tam_data2 as a INNER JOIN cc147_main_users_extended as b ON a.login = b.user1 
WHERE b.user5='$site' AND a.status = 'Contacted' AND a.kategori = 'Agree' AND a.follow = '6' AND a.valid = 'Valid' AND a.tgl BETWEEN '$date1 00:00:00' AND '$date2 23:59:59' 
GROUP BY tanggal, a.login, a.jenis ORDER BY tanggal, b.user5, a.login, a.jenis ASC;";
//echo $query;
$Page = $offset;
                            ...
                            <div class="row row-centered">
                                ...
                                <div align="center" class="col-md-4">
                                    ...
                                    if (isset($_POST['search'])) {
                                        ...
                                        $result = mysqli_query($con, $query) or die("Query gagal!");
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            $allData .= $row['tanggal'].','.$row['login'].','.$row['user2'].','.$row['user5'].','.$row['jenis'].','.$row['tot_jenis'].','.$row['revenue']."\n";
                                        }
                            ...
                            <div>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <th align=\"center\" style=\"font-size:12px\">" . $data['user2'] . "</th>
											<th align=\"center\" style=\"font-size:12px\">" . strtoupper($data['user5']) . "</th>
