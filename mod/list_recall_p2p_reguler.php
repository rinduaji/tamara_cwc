							...
							<div class="card ">
								...
								<div style="overflow-x:auto;">
									...
									<table id="data-table" class="table table-hover table-striped">
										...
										<tbody>
										<?php
										$query="SELECT a.id,a.tgl,a.login,a.perner,a.nama_agent,a.area,a.init_offer,a.label,a.msisdn,a.jenis,a.status,a.kategori,a.reason,a.keterangan,a.rec_qco,a.rec_tl,a.id_return_tl,a.type_p2p FROM app_tam_p2p a LEFT JOIN app_tam_return b ON a.id_return_tl=b.keterangan WHERE a.follow = '5' AND a.type_p2p='REGULER' $whr ORDER BY a.tgl DESC";
										// echo "$query";
