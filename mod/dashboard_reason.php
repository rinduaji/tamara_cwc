...
<!doctype html>
<html lang="en">
<form id='input' name="demoform" action='dashboard_reason.php' method='post' accept-charset='UTF-8'>
	<div class="row ">
	<div align="center" class="panel-heading">
                            <H3>DASBOARD TOP REASON DECLINE</H3>
                        </div>
	...
	<?php if(isset($_POST['date1']) && isset($_POST['date2'])){
		...
		$query1="SELECT  reason, COUNT(reason) as jml
				FROM app_tam_data2 
				WHERE  tgl between '$tgl_st 00:00:00' and '$tgl_en 23:59:59' and `status` = 'Contacted' and kategori = 'Not Agree'
...
var chart = new CanvasJS.Chart("chartContainer1", {
	...
	data: [{
		...
		?>
			{ label: "<?php echo $data1['reason']; ?>", y: <?php echo $data1['jml']; ?>,  },
		<?php
			}
		?>
