...
if(isset($id)) {
    ...
    if ($status_ubah == "Edit") {
        ...
        tgl_qco1 = '$tgl_qco1', valid='$valid', input='$input',
        add_on_tsel = '$add_on_tsel', id_return_tl = '$return_tl',durasi = '$durasi'  WHERE id='$id'";
    ...
    // if($tgl != "" AND $fastel != "") {
        ...
        `reason`, `penerima`, `ket`, `follow`, `upd_qco`, `rec_qco`, `tgl_qco1`, `valid`, `input`, `add_on_tsel`, `status_history`, `upd`, `nama_upd`, `jabatan_upd`, `tgl_input`, `id_return_tl`,`durasi`) VALUES ('$tgl', '$login', '$fastel', '$nama_dm', '$tlp', '$reg', '$jenis', '$status', '$kategori', 
        '$reason', '$penerima', '$ket', '$follow', '$upd_qco', '$rec_qco', '$tgl_qco1', '$valid', '$input', '$add_on_tsel', '$ubah_data','$username','$nama','$jb','$date_now', '$return_tl','$durasi')";
        // print_r($query);
        mysqli_query($con, $query);
    // }
}
				...
				<div class="card card-plain">
					...
					<form name="demoform" action='pengubahan_data.php' method='post' accept-charset='UTF-8'>
						...
						<div class="col-md-12">
							<div class="card ">
								<div class="header">
									<h4 class="title" style="color:#008B8B">Data TAMARA</h4>
								</div>
								<?php
									...
									<table class="table table-hover table-striped">
										...
										echo"<tr>
											...
											echo "<th align=\"center\" style=\"font-size:10px\">
													...
													data-tgl_qco1=\"".$data['tgl_qco1']."\" 
                                                    data-id_return_tl=\"".$data['id_return_tl']."\"   
													data-valid=\"".$data['valid']."\" 
                                                    data-input=\"".$data['input']."\" 
													data-add_on_tsel=\"".$data['add_on_tsel']."\" 
