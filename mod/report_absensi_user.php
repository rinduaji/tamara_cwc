		...
		<div class="content">
			...
			<div class="col-md-12">
				<div class="card card-plain">
					...
					<form name="demoform" action='report_absensi_user.php' method='post' accept-charset='UTF-8'>
                        ...
                        <tr>
								...
								<button name="refresh" type="submit" class="btn btn-primary" onClick="location.href='report_absensi_user.php';">Refresh</button>
							</tr>
						...
						<div class="col-md-12">
							<div class="card ">
								<div class="header">
									<h4 class="title" style="color:#008B8B">DAFTAR ABSEN </h4>
								</div>
								<?php
