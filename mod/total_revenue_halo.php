...
$query = "SELECT DATE_FORMAT(tgl, '%Y-%m-%d') as tanggal, login, nama_agent, area, jenis,  COUNT(jenis) as tot_jenis, SUM(REPLACE((SUBSTR(reason, 21)),'.','')) as revenue FROM app_tam_halo
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-plain">
                    ...
                    <form id='input' name="demoform" action='total_revenue_halo.php' method='post' accept-charset='UTF-8'>

                        <div align="center" class="panel-heading">
                            <b>TOTAL REVENUE HALO</b>
                        </div>
                        <div>
