...
$query = "SELECT DATE_FORMAT(tgl, '%Y-%m-%d') as tanggal, login, nama_agent, area, jenis, type_p2p,  COUNT(type_p2p) as tot_jenis, SUM(SUBSTR(reason, 1, 6)) as revenue FROM app_tam_p2p
WHERE area='$site' AND status = 'Contacted' AND kategori = 'Agree' AND follow IN ('2', '6') AND valid = 'Valid' AND tgl BETWEEN '$date1 00:00:00' AND '$date2 23:59:59' 
GROUP BY tanggal, login, jenis ORDER BY tanggal, area, login, jenis, type_p2p ASC;";
// echo $query;
$Page = $offset;
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-plain">
                    ...
                    <form id='input' name="demoform" action='total_revenue_p2p.php' method='post' accept-charset='UTF-8'>

                        <div align="center" class="panel-heading">
                            <b>TOTAL REVENUE P2P</b>
                        </div>
                        <div>
                            <div class="row row-centered">
                                ...
                                <div align="center" class="col-md-4">
                                    ...
                                    if (isset($_POST['search'])) {
                                        ...
                                        $result = mysqli_query($con, $query) or die("Query gagal!");
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            $allData .= $row['tanggal'].','.$row['login'].','.$row['nama_agent'].','.$row['area'].','.$row['jenis'].' '. $row['type_p2p'] .','.$row['tot_jenis'].','.$row['revenue']."\n";
                                        }
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card ">
                                            ...
                                            <th align=\"center\" style=\"font-size:12px\">" . $data['jenis'] .' '. $data['type_p2p']. "</th>
