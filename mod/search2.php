		...
		<div class="content">
			...
			<div class="col-md-12">
				<div class="card card-plain">
					...
					<form id='input' name="demoform" action='search2.php' method='post' accept-charset='UTF-8'>
						
						<div align="center" class="panel-heading">
                            <b>SEARCH DATA TELEPON DUPLICATE</b>
                        </div>
								...
								<div style="overflow-x:auto;">
									...
									<table id="data-table" class="table table-hover table-striped">
										...
										if (isset($_POST['search'])){
											...
											$query="SELECT 
	atd.tgl as tanggal, atd.login, u.user2 as nama , u.user5 as site , atd.fastel, atd.nama_dm, atd.tlp, atd.penerima, atd.reg, atd.jenis, atd.status, atd.valid, atd.kategori, atd.reason, atd.input, atd.ket, atd.upd_qco, atd.rec_qco
FROM 
