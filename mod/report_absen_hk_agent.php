...
if($date1 != "" && $date2 != "") {
	...
	$query="SELECT b.date_absen,a.user1, a.user2, a.user3, a.user4, a.user5, COUNT(*) as hk FROM cc147_main_users_extended as a INNER JOIN app_tam_absen as b ON a.user1 = b.username 
			WHERE b.date_absen BETWEEN '$date1 00:00:00' AND '$date2 23:59:59' AND b.keterangan = 'IN' AND a.user1 = '".$login."' AND a.user3 = '".$jabatan."' AND a.user5 = '".$area."' GROUP BY a.user1 ORDER BY a.user5, a.user3, a.user2  ASC";
    $no=0;
    // print_r($query);
	// die();
		...
		<div class="content">
			...
			<div class="col-md-12">
				<div class="card card-plain">
					<form name="demoform" action='report_absen_hk_agent.php' method='post' accept-charset='UTF-8'>
						...
						<tr>
                        	...
                        	<tr>
								...
								<button name="refresh" type="submit" class="btn btn-primary" onClick="location.href='report_absen_hk_agent.php';">Refresh</button>
							</tr>
								...
								<div style="overflow-x:auto;">
									<table class="table table-hover table-striped">
										...
										while($data = mysqli_fetch_array($hasil)) {
											if($data['user3'] == "Agent TAM" || $data['user3'] == "qa" || $data['user3'] == "TL TAM DCS" || $data['user3'] == "Trainer" || $data['user3'] == "Tabber TAM") {
												$t_kehadiran = 75000;
											}
											else {
												$t_kehadiran = 0;
