											...
											<table id="data-table" width="170px" class="table table-hover table-striped">
												...
												<tbody>
													...
													if ((!(isset($Login))) or ($Login == "")) {
														$query = "SELECT a.id,a.tgl,a.login,b.user2,b.user5,a.fastel,a.nama_dm,a.tlp,a.jenis,a.`status`,a.valid,a.upd_qco,a.prof_hoby,a.kategori,a.reason,a.ket FROM
