...
$query = "SELECT a.id,a.tgl,a.fastel,a.login,c.user2,a.upd_qco,c.user5,c.user1,d.name,a.kategori FROM app_tam_halo a INNER JOIN cc147_main_users_extended c ON a.login  = c.user1 INNER JOIN cc147_main_users d ON a.upd_qco=d.username WHERE a.tgl BETWEEN '$tanggaldate1' AND '$tanggaldate2' and a.status='Contacted' and a.kategori='Agree' and a.follow='2' ORDER BY a.upd_qco,a.tgl ASC";
// echo $query;


if ($id != "") {
	$query_edit = "UPDATE app_tam_halo SET upd_qco='$username_login' WHERE id='$id'";
														...
														<div class="modal fade" id="sendQCO<?= $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="Form Libur" aria-hidden="true" data-backdrop="false">
															<div class="modal-dialog" role="document">
																<div class="modal-content">
																	...
																	<form action="form_data_share_halo.php" method="POST" id="FormRekom_qa">
