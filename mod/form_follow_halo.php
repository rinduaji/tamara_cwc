			...
			if ($status_call == "Not Contacted" || $status_call == "Follow Up") {
				if ($no_telp == "" or $jenis_call == "" or $kategori == "" or $status_call == "" ) {
					...
					$sql = "INSERT INTO app_tam_halo (tgl,login,nama_agent,area,no_telp,no_ktp,tgl_setuju,no_kk,alamat_kirim,paket_halo,email,alamat,kategori,keterangan,follow,jenis,`status`,reason,fastel,nama_plg,input,kota,valid,reg) 
							...
							'$jenis_call','$status_call','$reason_call','$fastel','$nama_plg','Follow UP','$kota','Not Valid','$reg')";
				...
				if ($no_telp == "" or $jenis_call == "" or  $reason_call == "" or $kategori == "" or $status_call == "" ) {
					...
					if($kategori == "Agree"){
						if ($no_telp == "" or $msisdn == "" or $jenis_call == "" or $kategori == "" or $status_call == "" or $no_ktp == "" or $no_kk == "" or $alamat == "" or $alamat_kirim == "" or $email == "" 
							...
							$sql = "INSERT INTO app_tam_halo (tgl,login,nama_agent,area,no_telp,no_ktp,msisdn,reserve_id,area_tsel,tgl_setuju,no_kk,alamat_kirim,paket_halo,email,alamat,kategori,keterangan,follow,jenis,`status`,reason,fastel,nama_plg,input,kota,upd_qco,valid,reg) 
							VALUES 
							...
							'$jenis_call','$status_call','$reason_call','$fastel','$nama_plg','New','$kota','$login_qco','Not Valid','$reg')";
	...
	<title>App TAM</title>
		<div class="content">
			...
			<div class="col-md-12">
				...
				<form id='input' name="demoform" action='form_follow_halo.php?id=<?php echo "$id";?>' method='post' accept-charset='UTF-8'>
